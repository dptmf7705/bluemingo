            ...
            <div class="box-header">
              ...
              <table class="table table-search">
                ...
                <tr class="scrollLocation">
                  ...
                  <th>광고번호<div class="input-group input-group-sm" style="width: 150px;">
                  <input type="text" name="table_search" class="form-control pull-right" placeholder="Search5">
                  ...
                  <th>분류<div class="input-group-btn"><form role="form" method="get">
                    <input type="text" name="item_search" class="form-control pull-right" placeholder="Search">
                  
                  <div class="input-group-btn">
                    <button type="submit" class="btn btn_search-default"><i class="fa fa-search"></i></button>
                  </div>
                  </form></div></th>
                
                <th>날짜<div class="input-group input-group-sm" style="width: 150px;">
                  <input type="date" name="table_search" class="form-control pull-right" >
