...
function testOp(){
	alert(document.getElementById("option_test0").value)
}
		...
		<table class="advtable advtable-bordered table-hover detail-table text-center">
			<tr>
				<td>
					...
					<input name="item_name" type="text" class="form-control" id="input_item_name" placeholder="제품이름을 입력하세요">
                </td>
                ...
                <td>
					...
					<input name="company_key" type="text" class="form-control" id="input_company_key" placeholder="판매자 번호를 입력하세요">
                </td>
			</tr>
			<tr>
				<td colspan="3">
			...
			<tr>
				<td>
					...
					<input name="item_category_top" type="text" class="form-control" id="input_item_category_top" placeholder="제품이름을 입력하세요">
                </td>
                <td>
					<label for="input_item_data">카테고리 2차</label>
					<input name="item_category_mid" type="text" class="form-control" id="input_item_category_mid" placeholder="판매자 번호를 입력하세요">
                </td>
                <td>
					<label for="input_item_data">카테고리 3차</label>
					<input name="item_category_bot" type="text" class="form-control" id="input_item_category_bot" placeholder="판매자 번호를 입력하세요">
                </td>
			</tr>
			<tr>
				<td>
					<label for="input_item_data">즉시구매가</label>
					<input name="item_direct_price" type="text" class="form-control" id="input_item_direct_price" placeholder="제품이름을 입력하세요">
                </td>
                <td>
					<label for="input_item_data">공동구매가</label>
					<input name="item_sale_price" type="text" class="form-control" id="input_item_sale_price" placeholder="판매자 번호를 입력하세요">
                </td>
                <td>
					<label for="input_item_data">N사 최저가</label>
					<input name="item_naver_price" type="text" class="form-control" id="input_item_naver_price" placeholder="판매자 번호를 입력하세요">
                </td>
			</tr>
			<tr>
				<td colspan="3">
					<label for="input_item_data">짧은 설명</label>
					<textarea name="item_inform" class="form-control" placeholder="Enter Message" rows="3"></textarea>
                </td>
	        </tr>
		</table>
	</div>
		...
		<table class="advtable advtable-bordered table-hover detail-table text-center">
	        ...
	        <tr>
				<td>
					...
					<textarea name="item_detail_inform" class="form-control" placeholder="Enter Message" rows="5"></textarea>
                </td>
	        </tr>
		</table>
